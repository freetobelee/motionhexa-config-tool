...
void setup() {
  ...
  // IshiharaDigits (see patterns.h) is left defined but unregistered for now.
  ...
  patternManager.registerPattern<RickRoll>();
  patternManager.registerPattern<AnalogClock>();
  patternManager.registerPattern<SolarSystem>();
  patternManager.registerPattern<Billiards>();
  // HexMaze (see patterns.h) is left defined but unregistered for now.
  patternManager.registerPattern<WorkoutTimer>();
